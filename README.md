# Quick 'n Dirty File Loader for Majora's Mask: Recompiled

This is a mod for Majora's Mask: Recompiled that exposes some basic utilities for reading files from the operating system.

The API is unstable and make break between updates.
